...
class Tokenizer
{
    public static Tokenize(text : string) : Array<string> | undefined
    {
    ...
    static TokenizeText(text : string) : Array<string> | undefined
    {
        text = this.RemoveGutendexText(text);
        return this.Tokenize(text);
    }

    static RemoveGutendexText(text: string): string
    {

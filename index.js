...
import ForwardIndexDocument from './ForwardIndexDocument.js';
import ForwardIndexTable from './ForwardIndexTable.js';
  ...
  try {
    ...
    if(response.status == 200) {
      ...
      if(retrieved.status == 200) {
        ...
        const keywords = ForwardIndexDocument(book_content);
        tokenizedTable.addBooktoForwardTable(book.id, keywords);
